...
export function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-secondary text-white-200 flex flex-col gap-3 rounded-xl border border-white/20 py-6 shadow-sm",
        className
      )}
      {...props}
    />
...
export function CardIcon({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card-icon"
      className={cn(
        "flex bg-background-secondary size-16 justify-center rounded-3xl text-white items-center transition-all duration-300",
        className
      )}
      {...props}
    />
...
export function CardSeparator({
  ...
  return <Separator className={cn("bg-secondary-hover", className)} {...props} />;
}
